...
(
    ...
    post_id                int             null comment 'The Post ID associated with this quote',
    original_post_id       int             null comment 'The original post that the post_id is quoting',
    ...
    constraint quotes_posts_id_fk
        foreign key (post_id) references posts (id),
    constraint quotes_posts_id_fk_2
