...
(
    ...
    public_id                  varchar(255) null comment 'The Unique Public ID for this session',
    ...
    device_model               varchar(255) null comment 'The device model used to create this session',
    platform                   varchar(255) null comment 'The platform that created this session',
    system_version             varchar(255) null comment 'The system version used to create this session',
    ...
    session_cache              blob         null comment 'Session Cache Data, ZiProto encoded',
    session_data               blob         null comment 'Session Data, ZiProto encoded',
