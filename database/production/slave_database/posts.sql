...
(
    ...
    likes_count                  int default 0 not null comment 'The amount of likes this post has gotten (Query calculated)',
    reposts_count                int default 0 not null comment 'The amount of reposts this post has gotten (Query calculated)',
    quotes_count                 int default 0 not null comment 'The amount of quotes this post has gotten (Query calculated)',
