...
(
    ...
    post_id                int             null comment 'The Post ID associated with this reply',
    reply_post_id          int             null comment 'The Post ID of the reply',
    ...
    constraint replies_reply_posts_id_fk_2
