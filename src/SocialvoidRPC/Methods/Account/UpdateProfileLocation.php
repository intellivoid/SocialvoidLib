<?php
    ...
    class UpdateProfileLocation implements MethodInterface, StandardMethodInterface
    {
        ...
        {
            return 'update_profile_location';
        }
        ...
        public static function getStandardPossibleErrorCodes(): array
        {
            return [
                ...
                SessionExpiredException::getErrorCode(),
                InvalidGeoLocationException::getErrorCode(),
        ...
        public static function getStandardParameters(): array
        {
            return [
                ...
                ], true, 'The location text to set to the users profile')
            ];
        }
