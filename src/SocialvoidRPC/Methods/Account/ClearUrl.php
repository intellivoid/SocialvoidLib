<?php
    ...
    class ClearUrl implements MethodInterface
    {
        ...
        public function execute(Request $request): Response
        {
            ...
            catch(Exception $e)
            {
                ...
                // If anything else, suppress the error.
                throw new InternalServerException('There was an unexpected error while trying to clear your profile\'s url', $e);
            }
