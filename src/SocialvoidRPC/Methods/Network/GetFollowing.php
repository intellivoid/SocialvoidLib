<?php
    ...
    class GetFollowing implements MethodInterface
    {
        ...
        {
            return 'Returns an array peers that the given peer is following';
        }
        ...
        public function execute(Request $request): Response
        {
            ...
            try
            {
                ...
                $following = $NetworkSession->getUsers()->getFollowing($requested_peer, $request->Parameters['limit'], $request->Parameters['offset']);
                $following_std = [];

                foreach($following as $follower)
                    $following_std[] = Peer::fromUser($follower)->toArray();

                $Response = Response::fromRequest($request);
                $Response->ResultData = $following_std;
