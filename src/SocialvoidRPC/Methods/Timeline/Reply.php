<?php
    ...
    class Reply implements MethodInterface
    {
        ...
        {
            return 'Composes a reply post to an existing post';
        }
        ...
        public function execute(Request $request): Response
        {
            ...
            try
            {
                $ComposedPost = $NetworkSession->getTimeline()->reply($request->Parameters['post'], $request->Parameters['text'], $request->Parameters['attachments']);
