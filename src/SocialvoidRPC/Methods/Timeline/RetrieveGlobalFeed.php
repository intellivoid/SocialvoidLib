<?php
    ...
    class RetrieveGlobalFeed implements MethodInterface
    {
        ...
        {
            return 'timeline.retrieve_global_feed';
        }
        ...
        {
            return 'Returns an array of posts from the global timeline';
        }
        ...
        public function execute(Request $request): Response
        {
            ...
            try
            {
                $posts = $NetworkSession->getTimeline()->retrieveGlobalFeed((int)$request->Parameters['page']);
                $posts_array = [];
            ...
            catch(Exception $e)
            {
                ...
                throw new InternalServerException('There was an unexpected error while trying to retrieve the global timeline', $e);
            }
        }
    }