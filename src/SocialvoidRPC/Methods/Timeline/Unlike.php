<?php
    ...
    class Unlike implements MethodInterface
    {
        ...
        {
            return 'Unlikes an existing post on the timeline';
        }
        ...
        public function execute(Request $request): Response
        {
            ...
            catch(Exception $e)
            {
                ...
                // If anything else, suppress the error.
                throw new InternalServerException('There was an unexpected error while trying to unlike the requested post', $e);
            }
