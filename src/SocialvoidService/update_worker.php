...
// Import all required auto loaders
    ...
    SocialvoidService::getLogHandler()->log(EventType::INFO, "Starting Update Worker", "Update Worker");
    ...
    // Search Queries
    SocialvoidService::getBackgroundWorker()->getWorker()->getGearmanWorker()->addFunction("update", function(GearmanJob $job){
    ...
    // Start working
    SocialvoidService::getLogHandler()->log(EventType::INFO, "Worker started successfully", "Update Worker");
    ...
    while(true)
    {
        ...
        )
        {
            ...
            {
                SocialvoidService::getLogHandler()->log(EventType::WARNING, "Gearman returned error code " . SocialvoidService::getBackgroundWorker()->getWorker()->getGearmanWorker()->returnCode(), "Update Worker");
                break;
            }
        }
    }
