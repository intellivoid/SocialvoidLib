<?php
    ...
    $Socialvoid->getUserManager()->registerUser("netkas", "Jay", "Smith");
    $User = $Socialvoid->getUserManager()->getUser(\SocialvoidLib\Abstracts\SearchMethods\UserSearchMethod::ByUsername, "netkas");

    print(json_encode($User->toArray(), JSON_PRETTYc_PRINT | JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES));