<?php
    ...
    var_dump($NetworkSession->getUsers()->followPeer("@jaytoo"));

    print("@jaytoo" . PHP_EOL);
    print(json_encode($NetworkSession->getUsers()->getFollowerData("@jaytoo")->toArray(), JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE | JSON_PRETTY_PRINT) . PHP_EOL);

    print("@netkas" . PHP_EOL);
    print(json_encode($NetworkSession->getUsers()->getFollowerData("@netkas")->toArray(), JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE | JSON_PRETTY_PRINT) . PHP_EOL);